...
Defines the branded Unitary application icon shown as the launcher/favicon icon
on Android, iOS, and web, with `assets/icon/unitary.svg` as the canonical source
and a repeatable, development-time-only generation step for the platform assets.

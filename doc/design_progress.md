...
- *Project site on a custom domain (September 25, 2026)*: see `openspec/changes/pages-site/`
  ...
  - About screen: "Project home" now opens `https://unitary.wisnij.dev/`, and a new "Source code" entry opens the GitHub repository, making the AGPL §13 source offer an entry of its own

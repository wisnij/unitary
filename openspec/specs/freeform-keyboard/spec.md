# Spec: Freeform Keyboard

## Purpose

Defines the supplementary symbol key panel that appears above the system keyboard
in the freeform screen, giving users one-tap access to expression syntax characters
that are not readily available on the standard mobile keyboard.

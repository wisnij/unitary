...
Defines how the parser handles unit identifiers that end with one or more digit characters, distinguishing between exponent shorthand (trailing single digit 2–9), part-of-name cases (trailing 0 or 1, underscore-preceded digits), and parse errors (ambiguous multi-digit trailing runs).

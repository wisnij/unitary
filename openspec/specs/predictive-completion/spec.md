...
Provide inline unit, function, and prefix suggestions in freeform expression fields as the user types, allowing tap-to-insert completion of partial identifiers.

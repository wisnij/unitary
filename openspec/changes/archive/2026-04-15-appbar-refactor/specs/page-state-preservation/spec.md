...
The app SHALL retain the contents of the "Convert from" and "Convert to" text fields on the Freeform page when the user navigates to another top-level page and returns within the same session.
...
The app SHALL retain the contents of all worksheet row text fields when the user navigates to another top-level page and returns within the same session.
...
The app SHALL retain the browse page search bar visibility and query when the user navigates to another top-level page and returns within the same session.

...
Gives the custom-drawn interactive controls in Freeform mode — the operator key
panel and the predictive-completion suggestion overlay — accessible labels in

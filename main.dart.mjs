...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1333: () => globalThis.window.navigator.userAgent,
      ...
      _1410: (a, i) => a.push(i),
      _1411: (a, i) => a.splice(i, 1)[0],
      _1413: (a, l) => a.length = l,
      _1414: a => a.pop(),
      _1415: (a, i) => a.splice(i, 1),
      _1416: (a, s) => a.join(s),
      _1417: (a, s, e) => a.slice(s, e),
      _1418: (a, s, e) => a.splice(s, e),
      _1419: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1420: a => a.length,
      _1422: (a, i) => a[i],
      _1423: (a, i, v) => a[i] = v,
      _1425: o => {
      ...
      _1578: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1578(f,arguments.length,x0,x1,x2) }),
      ...
      _1604: (d, precision) => d.toPrecision(precision),

...
const Map<String, String> predefinedDimensionLabels = {
  ...
  'kg / m^3': 'Density',
  'kg / s^2': 'Energy flux; surface tension',
...
/// units are already registered and can be resolved.
void registerPiecewiseFunctions(UnitRepository repo) {
  {
    final output = ExpressionParser(repo: repo).evaluate('degR');
  ...
  {
    final output = ExpressionParser(repo: repo).evaluate('K');
    repo.registerFunction(
      PiecewiseFunction(
        id: 'sugar_conc_bpe',
        outputUnit: output,
  ...
  {
    final output = ExpressionParser(repo: repo).evaluate('0.99717g/cm^3');
    repo.registerFunction(
      PiecewiseFunction(
        id: 'brix',
        outputUnit: output,
  ...
  {
    final output = ExpressionParser(repo: repo).evaluate('1');
    repo.registerFunction(
      PiecewiseFunction(
        id: 'UScpi',
        outputUnit: output,
        ...
        points: const [
          ...
          (2014.4166666666667, 237.9),
          (2014.5, 238.343),
          (2014.5833333333333, 238.25),
          ...
          (2023.0, 296.797),
          (2023.0833333333333, 299.17),
          (2023.1666666666667, 300.84),
          (2023.25, 301.836),
          ...
          (2024.1666666666667, 310.326),
          (2024.25, 312.332),
          (2024.3333333333333, 313.548),
          (2024.4166666666667, 314.069),
          (2024.5, 314.175),
          (2024.5833333333333, 314.54),
          (2024.6666666666667, 314.796),
          (2024.75, 315.301),
          (2024.8333333333333, 315.664),
          (2024.9166666666667, 315.493),
          (2025.0, 315.605),
          (2025.0833333333333, 317.671),
          (2025.1666666666667, 319.082),
          (2025.25, 319.799),
          (2025.3333333333333, 320.795),
          (2025.4166666666667, 321.465),
          (2025.5, 322.561),
          (2025.5833333333333, 323.048),
          (2025.6666666666667, 323.976),
          (2025.75, 324.8),
          (2025.9166666666667, 324.122),
        ],
      ),
    );
  }
  ...
  {
    final output = ExpressionParser(repo: repo).evaluate('micron');
    repo.registerFunction(
      PiecewiseFunction(
        id: 'grit_P',
        outputUnit: output,

...
Persist the user's active worksheet template selection and per-template source
values across app sessions using SharedPreferences, so the worksheet screen
resumes in the same state the user left it.

...
Defines a reusable, page-agnostic two-pane layout that collapses to a single
pane by window size class and supports configurable per-pane sizing (fixed,
fit-content, and fill).

...
Specifies the behaviour of `formatQuantity`, the function responsible for
converting a `Quantity` value into a human-readable string suitable for
display in the freeform evaluation UI.
